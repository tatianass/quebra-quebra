...
#data_remuneracao_sem_licenca_premio <- mutate()

keeps <- c("Nome","Cargo","Especialidade","Situação","Mês","Ano","Remuneração (R$)")
salariosAgregados <- aggregate(remuneracao_total_liquida~nome+cargo+especialidade+situacao+mes+ano, FUN=sum, data)
