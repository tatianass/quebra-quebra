...
qtde_assessores <- readr::read_csv(file="../../dados//qtde_assessores.csv")
...
assessores_ja <- readr::read_csv(file="../../dados//assessores_joao_alberto.csv")
...
####################### Assessores João Alberto #######################
assessores_col <- readr::read_csv(file="../../dados//assessores_collor.csv")
...
assessores_he <- readr::read_csv(file="../../dados//assessores_helio_jose.csv")
