...
Na marioria das análises que fizemos usamos a remuneração líquida do servidor.
-----------------------------------------------------------------------
...
qtde_assessores <- readr::read_csv(file="~/Documents/quebra-quebra/src/processa_dados_senado/AnaliseDescritiva/qtde_assessores.csv")
...
assessores_ja <- readr::read_csv(file="~/Documents/quebra-quebra/src/processa_dados_senado/AnaliseDescritiva/assessores_joao_alberto.csv")
...
####################### Assessores João Alberto #######################
assessores_col <- readr::read_csv(file="~/Documents/quebra-quebra/src/processa_dados_senado/AnaliseDescritiva/assessores_collor.csv")
...
assessores_he <- readr::read_csv(file="~/Documents/quebra-quebra/src/processa_dados_senado/AnaliseDescritiva/assessores_helio_jose.csv")
