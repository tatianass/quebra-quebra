...
y1$print('chart2', include_assets = TRUE)
```

Fontes (todas as fontes foram acessadas em 30/07/2017):
...
df[,2] = format(df[,2],small.mark = '.',decimal.mark = ',')
...
p1$print('chart3', include_assets = TRUE)
