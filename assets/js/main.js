(function() {
    ...
    function renderAnnotations() {
        chart.append('div')
            ...
            .html('<b>2013</b><br>Cargo de Comissão foi a categoria que mais<br> cresceu desde 2013, cerca de 100% em 3 anos')
        ...
        chart.append('div')
            .attr('class', 'gia-sotu-annotation')
            .html("<b>2016</b><br>Maior valor registrado, 800 milhões para o<br> cargo de Analista Legislativo")
            .style('top', margin.top + 'px')
            .style('left', margin.left + 610 + 'px')
            .append('div')
            .attr('class', 'gia-sotu-annotation-line')
            .style('height', '70px')
        ...
        chart.append('div')
            .attr('class', 'gia-sotu-annotation')
            .html('<b>2016</b><br>Aumento de quase 100 milhões na <br>remuneração do Cargo em Comissão')
            .style('top', margin.top + 85 + 'px')
            .style('left', margin.left + 580 + 'px')
            .append('div')
            .attr('class', 'gia-sotu-annotation-line')
            .style('height', '75px')
        ...
        chart.append('div')
            .attr('class', 'gia-sotu-annotation')
            .html("<b>Junho de 2017</b><br>Metade do ano, e tudo indica que o gasto só vai aumentar, com exceção de Cargo Isolado, todos os outros cargos já estão com mais de 50% da remuneração total do ano passado")
            .style('top', margin.top + 135 + 'px')
            .style('left', margin.left + 763 + 'px')
            .append('div')
            .attr('class', 'gia-sotu-annotation-line')
            .style('height', '10px')
    ...
    function renderPoints() {
        ...
        points.enter()
            ...
            .attr('r', function(d) {
                return wordCountScale(d.kincaid)
            })
    ...
    function renderPopup() {
        if (selectedSpeech) {
            ...
            var leftPadding = Math.round(wordCountScale(selectedSpeech.kincaid)) + 26;
    ...
    function renderPresidents() {
        ...
        presEl
            ...
            .attr('id', function(d) {
                return 'gia-sotu-president-' + d.id
            })
            .style('clear', function(d, i) {
                return i % CONFIG.row_cells === 0 ? 'left' : ''
            })
    ...
    function selectByX(x) {
        var date = new Date(xScale.invert(x)).getTime(),
            mouseoverSpeech;
    ...
    d3.json('assets/dados/readability.min.json', function(json) {
        presidents = json;
